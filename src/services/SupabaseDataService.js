...
const mapGift=g=>({id:g.id,name:g.name,category:g.category_name,type:g.gift_type,target:g.target_quantity,reserved:g.reserved_quantity,description:g.description,emoji:g.emoji,image:g.image_url,url:g.product_url,status:g.status,sortOrder:g.sort_order});
