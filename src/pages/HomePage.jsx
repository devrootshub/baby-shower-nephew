...
export default function HomePage(){
  ...
  return <><Header/><main>
    ...
    <section className="section gifts" id="presentes"><div className="section-head centered"><p className="eyebrow">UM MIMINHO PARA O BEBÉ</p><h2>Lista de <em>presentes</em></h2><p>A tua presença é o presente mais importante para nós. Caso pretendas oferecer algo ao bebé, preparámos algumas sugestões. O link de cada artigo é apenas uma referência — podes adquiri-lo na loja indicada ou noutro local da tua preferência.</p></div><GiftRegistry/></section>
